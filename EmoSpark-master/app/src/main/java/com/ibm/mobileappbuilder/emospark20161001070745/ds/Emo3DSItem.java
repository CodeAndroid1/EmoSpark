...
public class Emo3DSItem implements Parcelable, IdentifiableBean {
    ...
    public static final Creator<Emo3DSItem> CREATOR = new Creator<Emo3DSItem>() {
        @Override
        public Emo3DSItem createFromParcel(Parcel in) {
            Emo3DSItem item = new Emo3DSItem();
        ...
        @Override
        public Emo3DSItem[] newArray(int size) {
            return new Emo3DSItem[size];
        }
    };

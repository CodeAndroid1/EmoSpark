...
import com.ibm.mobileappbuilder.emospark20161001070745.presenters.AngryDetailPresenter;
...
public class AngryDetailFragment extends ibmmobileappbuilder.ui.DetailFragment<Emo4DSItem> implements ShareBehavior.ShareListener  {

    private CrudDatasource<Emo4DSItem> datasource;
    public static AngryDetailFragment newInstance(Bundle args){
        AngryDetailFragment fr = new AngryDetailFragment();
        fr.setArguments(args);

        return fr;
    }

    public AngryDetailFragment(){
        super();
    }
    ...
    public void onCreate(Bundle state) {
        ...
        setPresenter(new AngryDetailPresenter(
        ...
        addBehavior(new FabBehaviour(this, R.drawable.ic_edit_white, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((DetailCrudPresenter<Emo4DSItem>) getPresenter()).editForm(getItem());
            }
        }));
    ...
    protected int getLayout() {
        return R.layout.angrydetail_detail;
    }
    ...
    @Override
    protected void onShow(Emo4DSItem item) {
    ...
    public void navigateToEditForm() {
        ...
        Intent intent = new Intent(getActivity(), Emo4DSItemFormActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == R.id.action_delete){
            ((DetailCrudPresenter<Emo4DSItem>) getPresenter()).deleteItem(getItem());
            return true;
        }
